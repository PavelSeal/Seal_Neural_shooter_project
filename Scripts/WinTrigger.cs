...
public class WinTrigger : MonoBehaviour
{
    ...
    public Text bestTimeText; // Текст для отображения рекорда
    ...
    void WinGame()
    {
        ...
        // Активируем окно победы только при создании
        currentWinScreen = Instantiate(winScreen);
        currentWinScreen.SetActive(true); // Явно активируем
        ...
        // Находим все текстовые элементы в UI победы
